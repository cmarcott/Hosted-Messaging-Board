                  ...
                  if (varChk == true) {
                    ...
                    while (strcmp(parsedStorage[findVars], ")") != 0) {
                      ...
                      if (varChk2 == true) {
                        ...
                        if (strcmp(parsedStorage[findVars], "struct") == 0) {
                          ...
                          strcat(funcArgs[funcArgsSize], parsedStorage[findVars]);
                        }
...
char * CopyFunctionFromClass(char * tempFunctionHolder, char ** parsedStorage, int * outerCount, int * TFHSize, char * classNameBuffer, char * classFunctionVars, struct Class * Classes) {
  ...
  bool nameFound, varChk, varChk2, moreThanOne, timeToAppend, timeToLoop, doneConflicts, returnCheck, methodCheck, parameterBoolean, firstLoop;
  char * nameBuffer;
  struct Class * current;
  oCount = *outerCount;
  pSize = *TFHSize;
  nameFound = varChk = varChk2 = moreThanOne = timeToAppend = timeToLoop = doneConflicts = returnCheck = methodCheck = parameterBoolean = firstLoop = false;
  methodNum = 0;
  ...
  while (strcmp(parsedStorage[oCount], "}") != 0) {
    ...
    /*Allows if statements and other statements requiring curly brackets to exist inside functions inside classes*/
